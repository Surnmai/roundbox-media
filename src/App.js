...
function App() {
  return (
    <>
      <section className="bg-hero h-[785px]  w-full bg-cover bg-no-repeat bg-center relative">
        <div className="container">
          ...
          {/* text and contact  */}
          <div className="flex justify-between mt-24 text-white font-dmSans">
            {/* text  */}
            ...
            <div className="rounded-lg bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1">
              <div className=" flex flex-col justify-center h-full w-full bg-transparent font-bold font-dmSans text-6xl p-6">
                <p>055 847 1720</p>
                <p>050 843 4937</p>
                <div className="flex">
                  <FaInstagram />
